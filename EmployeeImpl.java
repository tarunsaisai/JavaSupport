...
import com.java.support.JavaSupport.Service.Employee;
...
public class EmployeeImpl implements Employee {
	...
	public List<EmployeeModel> getEmpDetails() {
		...
		if (empId.equals("EMP12345")) {
			...
			logger.info("Employee Details Prepared >>>");

		} else {
			employee.setErrorCode("404");
			employee.setErrorMessage("Eplyee Details Not Found !...");
	...
	public List<EmployeeModel> getEmplyeeDetails() {
		logger.info("getEmplyeeDetails entering >>>> ");
		List<EmployeeModel> response = new ArrayList<EmployeeModel>();
		EmployeeModel employee = new EmployeeModel();
	...
	public List<EmployeeModel> king() {
